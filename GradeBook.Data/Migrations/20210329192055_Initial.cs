        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LectureTeacherId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Subjects_Teachers_LectureTeacherId",
                        column: x => x.LectureTeacherId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_LectureTeacherId",
                table: "Subjects",
                column: "LectureTeacherId",
                unique: true);
